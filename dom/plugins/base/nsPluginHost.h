...
public:
  ...
  // FIXME what if fake has different extensions
...
private:
  ...
  nsresult TrySetUpPluginInstance(const char *aMimeType, nsIURI *aURL,
                                  nsPluginInstanceOwner *aOwner);

  // FIXME comment here about when things may be fake
  nsPluginTag*
