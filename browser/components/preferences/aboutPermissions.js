...
let PermissionDefaults = {
  ...
  get push() {
    if (!Services.prefs.getBoolPref("services.push.userEnabled")) {
      return this.DENY;
    }
    return this.UNKNOWN;
  },
  set push(aValue) {
    let value = (aValue != this.DENY);
    Services.prefs.setBoolPref("services.push.userEnabled", value);
  },
...
let AboutPermissions = {
  ...
  init: function() {
    ...
    Services.prefs.addObserver("services.push.userEnabled", this, false);
  ...
  cleanUp: function() {
    if (this._observersInitialized) {
      ...
      Services.prefs.removeObserver("services.push.userEnabled", this, false);
